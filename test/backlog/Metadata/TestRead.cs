...
124,/test/data/test-case2.docx,.docx,2025-01-16 10:00:00,IA/2025/002,UKFTT-TC,Jones,HMRC"
        ...
        Assert.Collection(result,
            line => Assert.Equivalent(new Backlog.Src.Metadata.Line
            {
                id = "123",
                court = "UKUT-IAC",
    ...
    public void Read_WithAllPossibleColumns_ParsesCsvIntoLines()
    {
        ...
        const string csvContent = @"id,FilePath,Extension,decision_datetime,CaseNo,court,appellants,claimants,respondent,main_category,main_subcategory,sec_category,sec_subcategory,headnote_summary,jurisdictions,ncn
