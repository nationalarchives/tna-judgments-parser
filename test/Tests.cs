...
public class Tests {
    ...
    public void Test(int i) {
        ...
        actual = DocumentHelpers.RemoveSomeMetadata(actual);
        expected = DocumentHelpers.RemoveSomeMetadata(expected);
    ...
    public void TestWithImages(int i) {
        ...
        actualXml = DocumentHelpers.RemoveSomeMetadata(actualXml);
        expectedXml = DocumentHelpers.RemoveSomeMetadata(expectedXml);
