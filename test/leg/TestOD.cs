...
namespace UK.Gov.Legislation.OtherDocuments.Test {
...
public class TestOD {
    ...
    /// <summary>
    /// Gets test files with [prefix]od_[id]_en[_NNN].docx naming pattern.
    /// Other Documents may carry an optional _NNN version suffix.
    /// </summary>
    private static IEnumerable<object[]> GetTestFiles() {
        var assembly = System.Reflection.Assembly.GetExecutingAssembly();
        var resourceNames = assembly.GetManifestResourceNames();

        var regex = new Regex(@"^test\.leg\.od\.(.+od_[0-9]+_en(?:_\d+)?)\.docx$");
    ...
    public void RegenerateAllTestFiles() {
        ...
        foreach (var testData in TestFiles) {
            ...
            try {
                ...
                var testFolder = System.IO.Path.Combine(projectRoot, "test", "leg", "od");
